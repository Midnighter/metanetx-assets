...
Report bugs at https://github.com/Midnighter/metanetx-assets/issues.
...
metanetx-assets could always use more documentation, whether as part of the
...
https://github.com/Midnighter/metanetx-assets/issues.
...
Ready to contribute? Here's how to set up metanetx-assets for
local development.

1. Fork the https://github.com/Midnighter/metanetx-assets
   repository on GitHub.
2. Clone your fork locally

   .. code-block:: console
   
       git clone git@github.com:your_name_here/metanetx-assets.git
